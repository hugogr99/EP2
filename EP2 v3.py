...
#Essas funções servem para o jogador escolher o Inspermon com que deseja começar o jogo.
#São três opções: Xarmander, Bubussauro e Squirtlow         
...
#Função que direciona o jogador para o local escolhido. Cada local contém Inspermons de determinados elementos.
...
#Cada Inspermon tem um elemento
